...
async function seedDepartments() {
    try {
        ...
        const Cardiology = await Cloudinary_1.default.uploader.upload("./assets/heart.png", {
            folder: "department",
        });
        const Neurology = await Cloudinary_1.default.uploader.upload("./assets/BRAIN.png", {
            folder: "department",
        });
        ...
        await Department_1.default.insertMany(departmentSeed);
